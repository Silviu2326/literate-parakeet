...
export const Stories = ({ onNavigate }: StoriesProps) => {
  return (
    <div className="min-h-screen bg-[#0D0D0D]">
      <div className="bg-[#141414] border-b border-[#252525] px-4 py-4">
        ...
        <h1 className="text-white font-black text-2xl mb-1">📸 Stories</h1>
        <p className="text-gray-500 text-sm">Momentos destacados</p>
      </div>

      <div className="max-w-7xl mx-auto p-4">
        <div className="bg-[#141414] border border-[#252525] rounded-2xl p-8 text-center">
          <div className="text-6xl mb-4">📸</div>
          <h2 className="text-white font-bold text-xl mb-2">Stories</h2>
