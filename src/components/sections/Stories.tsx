...
export const Stories = ({ onNavigate, points }: StoriesProps) => {
  ...
  const getThemeColors = () => {
    switch (selectedTheme) {
      case 'classic':
        return { border: '#00E676', text: '#00E676', bg: 'rgba(0, 230, 118, 0.1)' };
      case 'fire':
      ...
      <MobileLayout onNavigate={onNavigate} currentView="dashboard">
        ...
        <div className="min-h-screen bg-[#0D0D0D]">
          ...
          <div className="stories-preview-header">
            <div className="stories-preview-icon rounded-3xl bg-gradient-to-br from-[#1a3a2e] to-[#0a1f19] border-2 border-[#00E676]/30">
          ...
          <div className="stories-preview-actions">
            <button
              onClick={handleShare}
              className="stories-preview-button border-[#00E676] text-[#00E676] hover:bg-[#00E676]/10"
            >
